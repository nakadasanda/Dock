...
{
    internal static class EnumerabelExtensions
    {
    ...
    /// </summary>
    class NavigateAdapter : INavigationAdapter
    {
        ...
        public void Navigate(object root,bool bSnapshot)
        {
            switch(root)
            {
                ...
                case string id:
                    ...
                    break;
                default:
                    throw new ArgumentException($"Invald root object type: {root.GetType()}");
            }
        }
