...
namespace Dock.Model
{
    ...
    class DockManager : IDockManager
    {
        ...
        internal void SplitToolDockable(IDockable sourceDockable,IDock sourceDockableOwner, IDock targetDock, DockOperation operation)
        {
            ...
            {
                IDock toolIDock = factory.CreateToolDock();
                toolIDock.Id = nameof(IToolDock);
                toolIDock.Title = nameof(IToolDock);
                toolIDock.VisibleDockables = factory.CreateList<IDockable>();
                factory.MoveDockable(sourceDockableOwner, toolIDock, sourceDockable, null);
                factory.SplitToDock(targetDock, toolIDock, operation);
            }
        }
